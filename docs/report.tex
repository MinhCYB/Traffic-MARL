...
Để đánh giá khả năng generalization, hệ thống được kiểm chứng trên map \textbf{UET} --- khu vực Đại học Công nghệ, Cầu Giấy (Hình~\ref{fig:uet_topology}), phức tạp hơn đáng kể với \textbf{15 ngã tư} (N01--N15) và 3 tuyến arterial song song (Xuân Thuỷ/Phạm Văn Đồng, Nguyễn Phong Sắc, và đường nội bộ row M).

\begin{figure}[!t]
    \centering
    \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.2em}
    \small
    \texttt{N01-N02-N03-N04-N05-N06}\\[0.2em]
    \texttt{~|~~~|~~~|~~~|~~~|~~~|}\\[0.2em]
    \texttt{N11~N12~N07-N08-N09-N10}\\[0.2em]
    \texttt{~|~~~|~~~|~~~|~~~|}\\[0.2em]
    \texttt{N11-N12-N13-N14-N15}
    \vspace{1.2em}}}
    \caption{Topology mạng lưới UET (15 ngã tư). Arterial 3 làn: Xuân Thuỷ, Nguyễn Phong Sắc. Secondary 2 làn: đường nội bộ.}
...
\textbf{Ưu điểm của GAT communication}: so với IDQN, GAT-MARL cho phép mỗi agent nhận thông tin từ neighbors, giúp phối hợp pha đèn giữa các ngã tư liền kề. Điều này đặc biệt có giá trị trên các trục arterial như Hồ Tùng Mậu hay Lê Đức Thọ, nơi hiệu ứng ``green wave'' có thể cải thiện đáng kể throughput.
